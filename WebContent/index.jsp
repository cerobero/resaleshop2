...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">
					최신 등록상품! <small><a href="list.do?view=">더보기</a></small>
				</h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">
					Hot! 등록상품 <small><a href="list.do?view=hot">더보기</a></small>
				</h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">
					프리미엄 등록상품 <small><a href="list.do?view=premium">더 보기</a></small>
				</h1>
			</div>
		</div>
