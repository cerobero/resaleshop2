...
<body>
	...
	<div class="container">
		<form class="form-group" action="c_rewrite.do" method="POST"
			enctype="multipart/form-data">
			<div class="hero-unit">
				<div id="legend">
					<h1 class="page-header">댓글 고치기</h1>
				</div>
	    ...
	    * https://github.com/mindmup/bootstrap-wysiwyg/blob/master/README.md#customising-
		--->
				...
				<div class="control-group text-center">
					<!-- Button -->
					<div class="controls">
						<textarea rows="15" cols="100" name="commentContent"></textarea><br>
						<input type="hidden" name="commentNo" value="${originalComment.commentNo}"> 
						<input type="hidden" id="type" name="type" value="c_rewrite.do">
						<input type="submit" value="수정 완료">
						<input type="button" value="수정 취소" onClick="location.href='read.do?articleNo=${originalComment.articleNo}';">
