...
<body>
	...
	<div class="container">
	<form class="form-group" action="itemInfo" method="POST" >
	  <div class="hero-unit">
		<div id="legend">
		  <h1 class="page-header">글삭제하기</h1>
		</div>
	    ...
	    * https://github.com/mindmup/bootstrap-wysiwyg/blob/master/README.md#customising-
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="control-label">판매여부</label>
					<input type="radio" value="1" name="soldout">&nbsp;판매완료&nbsp;
					<input type="radio" value="0" name="soldout" checked>&nbsp;판매중&nbsp;
			</div>			
		</div>
...
<!-- 	      <input type="submit" value="modify"> -->
	        <button class="btn btn-success" id="delete" >삭제하기</button>
	        <button class="btn btn-success" id="cancel">취소</button>
	      </div>
	    </div>
		</div>    
        </form>
