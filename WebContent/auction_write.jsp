...
<body>
	...
	<div class="container">
	<form class="form-group" action="auctionWrite.do" method="POST" enctype="multipart/form-data">
	  <div class="hero-unit">
		<div id="legend">
		  <h1 class="page-header">경매 글쓰기</h1>
		</div>
...
<!-- 				<input type="text" id="item" class="input-large"> -->
				...
				<input type="text" id="startPrice" class="input-large" name="startPrice">
				
				<label class="control-label" for="localEndDate" style="width: 60px;">종료일</label>
				<input type="datetime-local" id="localEndDate" class="input-large" name="localEndDate">

				<label class="control-label" for="file">사진등록</label>
